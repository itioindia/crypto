...
func CryptoCurrencyPost(c *fiber.Ctx) error {
	...
	result := database.DB.Db.Table("crypto_currency").Save(&models.CryptoCurrencyList{Crypto_id: getTableID, Crypto_code: crypto_code, Crypto_title: crypto_title, Crypto_network: crypto_network, Status: status})
